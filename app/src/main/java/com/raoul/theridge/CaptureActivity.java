...
import com.raoul.theridge.result.ResultHandler;
import com.raoul.theridge.result.ResultHandlerFactory;
...
public class CaptureActivity extends DecoderActivity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        ImageButton transButton = (ImageButton) findViewById(R.id.transferbutton);

        transButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                if(resultdata.contains("http")){Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(resultdata));
                    startActivity(browserIntent);}
                else {
                    Toast.makeText(CaptureActivity.this,"Scann data in not contains web url",Toast.LENGTH_LONG).show();
                }
    ...
    private void handleDecodeInternally(Result rawResult, ResultHandler resultHandler, Bitmap barcode) {
        ...
        resultdata=(String) displayContents;
